 ...
 */
public class EnemyDinosaur1 extends GameSprite {

    protected static final Rect source = new Rect(0, 0, 43, 25); //blue
    protected static final Point3F scale = Point3F.identity();
    protected SoundManager sounds;

    public EnemyDinosaur1(World theWorld, int ranx, int rany, SoundManager sounds) {
        super(theWorld);
