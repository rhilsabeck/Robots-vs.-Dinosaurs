...
public final class BidiFormatter {
     ...
     * an incorrect staticPosition. An LRM or RLM character (the one of the context's directionality)
     ...
     * thus being displayed in an incorrect staticPosition. An LRM or RLM character (the one of the
    ...
    private static class DirectionalityEstimator {
        ...
        /**
         * The current staticPosition in the text.
         */
