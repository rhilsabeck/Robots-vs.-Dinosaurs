...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    /** Interpolator used to scale velocity with touch staticPosition. */
     ...
     * the touch staticPosition enters an activation edge.
     *
     ...
     * to reach target velocity for the current touch staticPosition.
     * <p>
    ...
    private float computeTargetVelocity(
        ...
        // Target velocity is adjusted for interpolated edge staticPosition, then
    ...
    /**
     * Returns the interpolated staticPosition of a touch point relative to an edge
     ...
     *            total).
     * @param current Touch staticPosition within within the total size.
     * @return Interpolated value of the touch staticPosition within the edge.
     */
