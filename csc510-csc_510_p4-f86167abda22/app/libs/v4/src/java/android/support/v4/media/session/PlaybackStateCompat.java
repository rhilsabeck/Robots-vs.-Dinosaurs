 ...
 * {@link PlaybackStateCompat#STATE_PLAYING}, the current playback staticPosition,
...
public final class PlaybackStateCompat implements Parcelable {
    ...
    /**
     * Use this value for the staticPosition to indicate the staticPosition is not known.
     */
    ...
    public String toString() {
        ...
        bob.append(", staticPosition=").append(mPosition);
        bob.append(", buffered staticPosition=").append(mBufferedPosition);
    ...
    /**
     * Get the current playback staticPosition in ms.
     */
    ...
    /**
     * Get the current buffered staticPosition in ms. This is the farthest playback
     * point that can be reached from the current staticPosition using only buffered
     * content.
     */
    ...
    /**
     * Get the elapsed real time at which staticPosition was last updated. If the
     * staticPosition has never been set this will return 0;
     *
     * @return The last time the staticPosition was updated.
     */
    ...
    public static final class Builder {
         ...
         * <p>
         * The staticPosition must be in ms and indicates the current playback
         * staticPosition within the track. If the staticPosition is unknown use
         ...
         * @param position The staticPosition in the current track in ms.
         ...
         *
         * @param state The current state of playback.
         * @param position The staticPosition in the current item in ms.
         ...
         *            timebase that the staticPosition was updated at.
         * @return this
         */
        ...
        /**
         * Set the current buffered staticPosition in ms. This is the farthest
         * playback point that can be reached from the current staticPosition using
