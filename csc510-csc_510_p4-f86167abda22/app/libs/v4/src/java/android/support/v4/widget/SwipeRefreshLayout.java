...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    // Whether the client has set a custom starting staticPosition;
    ...
    private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                // Return the circle to its start staticPosition
                if (mScale) {
    ...
    /**
     * The refresh indicator starting and resting staticPosition is always positioned
     * near the top of the refreshing content. This staticPosition is a consistent
    ...
    /**
     * The refresh indicator resting staticPosition is always positioned near the top
     * of the refreshing content. This staticPosition is a consistent location, but
