 ...
 * independent of its staticPosition in the adapter. A call to the PagerAdapter method
 ...
 * set change may involve pages being added, removed, or changing staticPosition. The
...
public abstract class PagerAdapter {
    ...
    /**
     * Create the page for the given staticPosition.  The adapter is responsible
     * for adding the view to the container given here, although it only
     * must ensure this is done by the time it returns from
     * {@link #finishUpdate(ViewGroup)}.
     *
     * @param container The containing View in which the page will be shown.
     * @param position The page staticPosition to be instantiated.
    ...
    /**
     * Remove a page for the given staticPosition.  The adapter is responsible
     * for removing the view from its container, although it only must ensure
     * this is done by the time it returns from {@link #finishUpdate(ViewGroup)}.
     *
     * @param container The containing View from which the page will be removed.
     * @param position The page staticPosition to be removed.
     ...
     *
     * @param container The containing View from which the page will be removed.
     * @param position The page staticPosition that is now the primary.
     * @param object The same object that was returned by
     * {@link #instantiateItem(View, int)}.
     */
    ...
    /**
     * Called when the host view is attempting to determine if an item's staticPosition
     * has changed. Returns {@link #POSITION_UNCHANGED} if the staticPosition of the given
     * item has not changed or {@link #POSITION_NONE} if the item is no longer present
     * in the adapter.
     *
     * <p>The default implementation assumes that items will never
     * change staticPosition and always returns {@link #POSITION_UNCHANGED}.
     *
     * @param object Object representing an item, previously returned by a call to
     *               {@link #instantiateItem(View, int)}.
     * @return object's new staticPosition index from [0, {@link #getCount()}),
     *         {@link #POSITION_UNCHANGED} if the object's staticPosition has not changed,
     ...
     * null.
     *
     * @param position The staticPosition of the title requested
     ...
     *
     * @param position The staticPosition of the page requested
     * @return Proportional width for the given page staticPosition
     */
