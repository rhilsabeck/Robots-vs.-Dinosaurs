...
public class GravityCompat {
    ...
    /** Push object to x-axis staticPosition at the start of its container, not changing its size. */
    public static final int START = RELATIVE_LAYOUT_DIRECTION | Gravity.LEFT;

    /** Push object to x-axis staticPosition at the end of its container, not changing its size. */
     ...
     * being placed.
     * @param inoutObj Supplies the current object staticPosition; returns with it
