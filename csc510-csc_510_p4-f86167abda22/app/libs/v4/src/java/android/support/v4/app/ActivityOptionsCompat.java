...
public class ActivityOptionsCompat {
     ...
     * scaled from a given staticPosition to the new activity window that is being
     * started.
     * <p/>
     * If the Intent this is being used with has not set its
     * {@link android.content.Intent#setSourceBounds(android.graphics.Rect)},
     ...
     * animations. This method carries the staticPosition of one shared element to the started Activity.
     * The staticPosition of <code>sharedElement</code> will be used as the epicenter for the
     * exit Transition. The staticPosition of the shared element in the launched Activity will be the
    ...
    /**
     * Create an ActivityOptions to transition between Activities using cross-Activity scene
     * animations. This method carries the staticPosition of multiple shared elements to the started
     * Activity. The staticPosition of the first element in sharedElements
     * will be used as the epicenter for the exit Transition. The staticPosition of the associated
