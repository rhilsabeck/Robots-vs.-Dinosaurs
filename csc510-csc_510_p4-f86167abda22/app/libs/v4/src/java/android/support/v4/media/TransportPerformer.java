...
public abstract class TransportPerformer {
     ...
     * (staticPosition etc) it is in.
     */
    public abstract void onStart();

    /**
     * Request to pause playback of the media, staying at the current playback staticPosition
    ...
    /**
     * Request to return the current playback staticPosition, in milliseconds.
     */
    public abstract long onGetCurrentPosition();

    /**
     * Request to move the current playback staticPosition.
     * @param pos New staticPosition to move to, in milliseconds.
     */
