...
public abstract class TransportController {
    ...
    /**
     * Request that the player start its playback at its current staticPosition.
     */
    public abstract void startPlaying();

    /**
     * Request that the player pause its playback and stay at its current staticPosition.
     */
