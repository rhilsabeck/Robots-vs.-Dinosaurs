...
public class ViewDragHelper {
    ...
    /**
     * A view is currently being dragged. The staticPosition is currently changing as a result
    ...
    // Last known staticPosition/pointer tracking
    ...
    public static abstract class Callback {
        ...
        /**
         * Called when the captured view's staticPosition changes as the result of a drag or settle.
         *
         * @param changedView View whose staticPosition changed
         * @param left New X coordinate of the left edge of the view
         * @param top New Y coordinate of the top edge of the view
         * @param dx Change in X staticPosition from the last call
         * @param dy Change in Y staticPosition from the last call
         */
         ...
         *
         * @param index the ordered staticPosition to query for
         * @return index of the view that should be ordered at staticPosition <code>index</code>
         */
         ...
         * @param dx Proposed change in staticPosition for left
         * @return The new clamped staticPosition for left
         */
         ...
         * @param dy Proposed change in staticPosition for top
         * @return The new clamped staticPosition for top
         */
    ...
    /**
     * Animate the view <code>child</code> to the given (left, top) staticPosition.
     ...
     * @param finalLeft Final left staticPosition of child
     * @param finalTop Final top staticPosition of child
    ...
    /**
     * Settle the captured view at the given (left, top) staticPosition.
     * The appropriate velocity from prior motion will be taken into account.
     * If this method returns true, the caller should invoke {@link #continueSettling(boolean)}
     * on each subsequent frame to continue the motion until it returns false. If this method
     * returns false there is no further work to do to complete the movement.
     *
     * @param finalLeft Settled left edge staticPosition for the captured view
     * @param finalTop Settled top edge staticPosition for the captured view
     * @return true if animation should continue through {@link #continueSettling(boolean)} calls
     */
     ...
     * Settle the captured view at the given (left, top) staticPosition.
     *
     * @param finalLeft Target left staticPosition for the captured view
     * @param finalTop Target top staticPosition for the captured view
     ...
     *
     * @param minLeft Minimum X staticPosition for the view's left edge
     * @param minTop Minimum Y staticPosition for the view's top edge
     * @param maxLeft Maximum X staticPosition for the view's left edge
     * @param maxTop Maximum Y staticPosition for the view's top edge
     */
     ...
     * @param dx Motion since initial staticPosition along X axis
     * @param dy Motion since initial staticPosition along Y axis
     ...
     * will return false.
     *
     * @param x X staticPosition to test in the parent's coordinate system
     * @param y Y staticPosition to test in the parent's coordinate system
