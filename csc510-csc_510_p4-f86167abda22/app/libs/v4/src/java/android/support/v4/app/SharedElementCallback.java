...
public abstract class SharedElementCallback {
     ...
     * The shared element will start at the size and staticPosition of the shared element
     ...
     * <p>
     * Views in rejectedSharedElements will have their staticPosition and size set to the
     * staticPosition of the calling shared element, relative to the Window decor View and contain
     * snapshots of the View from the calling Activity or Fragment. This
     * view may be safely added to the decor View's overlay to remain in staticPosition.
     * </p>
