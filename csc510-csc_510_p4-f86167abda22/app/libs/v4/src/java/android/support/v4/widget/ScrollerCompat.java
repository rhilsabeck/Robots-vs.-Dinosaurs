...
public class ScrollerCompat {
    ...
    /**
     * @return The final X staticPosition for the scroll in progress, if known.
     */
    ...
    /**
     * @return The final Y staticPosition for the scroll in progress, if known.
     */
     ...
     *
     * @param startX Starting/current X staticPosition
     * @param finalX Desired final X staticPosition
     ...
     * startY to finalY.
     *
     * @param startY Starting/current Y staticPosition
     * @param finalY Desired final Y staticPosition
    ...
    /**
     * Returns whether the current Scroller is currently returning to a valid staticPosition.
     * Valid bounds were provided by the
     * {@link #fling(int, int, int, int, int, int, int, int, int, int)} method.
     *
     * One should check this value before calling
     * {@link #startScroll(int, int, int, int)} as the interpolation currently in progress
     * to restore a valid staticPosition will then be stopped. The caller has to take into account
     * the fact that the started scroll will start from an overscrolled staticPosition.
     *
     * @return true when the current staticPosition is overscrolled and in the process of
