...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /**
     * How far the panel is offset from its closed staticPosition.
     * range [0, 1] where 0 = closed, 1 = open.
     */
    private float mSlideOffset;

    /**
     * How far the non-sliding panel is parallaxed from its usual staticPosition when open.
     * range [0, 1]
     */
    ...
    public interface PanelSlideListener {
        /**
         * Called when a sliding pane's staticPosition changes.
         ...
         * @param panel The child view that was slid to an open staticPosition, revealing other panes
         */
         ...
         * @param panel The child view that was slid to a closed staticPosition
         */
     ...
     * fully closed state. The lower pane will scroll between this staticPosition and
    ...
    /**
     * Smoothly animate mDraggingPane to the target X staticPosition within its range.
     *
     * @param slideOffset staticPosition to animate to
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
         ...
         * when it's been offset from its default staticPosition.
         */
