...
public class NotificationCompat {
     ...
     * these items smaller, or at a different staticPosition in the list,
     ...
     * to show these items larger, or at a different staticPosition in
    ...
    public static final class WearableExtender implements Extender {
        ...
        /**
         * Set whether the scrolling staticPosition for the contents of this notification should start
        ...
        /**
         * Get whether the scrolling staticPosition for the contents of this notification should start
         * at the bottom of the contents instead of the top when the contents are too long to
         * display within the screen. Default is false (start scroll at the top).
         */
